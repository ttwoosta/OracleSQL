...
ALTER TABLE prob_officers ADD CONSTRAINT probofficers_status_ck CHECK (
	STATUS IN (
		'A',
		'I'
		)
...
ALTER TABLE sentences ADD CONSTRAINT sentences_type_ck CHECK (
	type IN (
		'J',
		'H',
		'P'
...
ALTER TABLE officers ADD CONSTRAINT officers_status_ck CHECK (
	STATUS IN (
		'A',
		'I'
		)
...
CREATE TABLE appeals (
	...
	CONSTRAINT appeals_status_ck CHECK (
		STATUS IN (
			'P',
			'A',
			'D'
...
CREATE TABLE crime_officers (
	crime_id BIGINT,
	officer_id INT,
	CONSTRAINT crimeofficers_cid_oid_pk PRIMARY KEY (
		crime_id,
		officer_id
		),
...
CREATE TABLE crime_charges (
	...
	CONSTRAINT crimecharges_status_ck CHECK (
		charge_status IN (
			'PD',
			'GL',
			'NG'
