...
INSERT INTO ORDERS 
VALUES (1000,1005,CONVERT(DATETIME, '31-MAR-09'),CONVERT(DATETIME, '02-APR-09'),'1201 ORANGE AVE', 'SEATTLE', 'WA', '98114' , 2.00); 
INSERT INTO ORDERS 
VALUES (1001,1010,CONVERT(DATETIME, '31-MAR-09'),CONVERT(DATETIME, '01-APR-09'), '114 EAST SAVANNAH', 'ATLANTA', 'GA', '30314', 3.00); 
INSERT INTO ORDERS 
VALUES (1002,1011,CONVERT(DATETIME, '31-MAR-09'),CONVERT(DATETIME, '01-APR-09'),'58 TILA CIRCLE', 'CHICAGO', 'IL', '60605', 3.00); 
INSERT INTO ORDERS 
VALUES (1003,1001,CONVERT(DATETIME, '01-APR-09'),CONVERT(DATETIME, '01-APR-09'),'958 MAGNOLIA LANE', 'EASTPOINT', 'FL', '32328', 4.00); 
INSERT INTO ORDERS 
VALUES (1004,1020,CONVERT(DATETIME, '01-APR-09'),CONVERT(DATETIME, '05-APR-09'),'561 ROUNDABOUT WAY', 'TRENTON', 'NJ', '08601', NULL); 
INSERT INTO ORDERS 
VALUES (1005,1018,CONVERT(DATETIME, '01-APR-09'),CONVERT(DATETIME, '02-APR-09'), '1008 GRAND AVENUE', 'MACON', 'GA', '31206', 2.00); 
INSERT INTO ORDERS 
VALUES (1006,1003,CONVERT(DATETIME, '01-APR-09'),CONVERT(DATETIME, '02-APR-09'),'558A CAPITOL HWY.', 'TALLAHASSEE', 'FL', '32307', 2.00); 
INSERT INTO ORDERS 
VALUES (1007,1007,CONVERT(DATETIME, '02-APR-09'),CONVERT(DATETIME, '04-APR-09'), '9153 MAIN STREET', 'AUSTIN', 'TX', '78710', 7.00); 
INSERT INTO ORDERS 
VALUES (1008,1004,CONVERT(DATETIME, '02-APR-09'),CONVERT(DATETIME, '03-APR-09'), '69821 SOUTH AVENUE', 'BOISE', 'ID', '83707', 3.00); 
INSERT INTO ORDERS 
VALUES (1009,1005,CONVERT(DATETIME, '03-APR-09'),CONVERT(DATETIME, '05-APR-09'),'9 LIGHTENING RD.', 'SEATTLE', 'WA', '98110', NULL); 
INSERT INTO ORDERS 
VALUES (1010,1019,CONVERT(DATETIME, '03-APR-09'),CONVERT(DATETIME, '04-APR-09'),'384 WRONG WAY HOME', 'MORRISTOWN', 'NJ', '07960', 2.00); 
INSERT INTO ORDERS 
VALUES (1011,1010,CONVERT(DATETIME, '03-APR-09'),CONVERT(DATETIME, '05-APR-09'), '102 WEST LAFAYETTE', 'ATLANTA', 'GA', '30311', 2.00); 
INSERT INTO ORDERS 
VALUES (1012,1017,CONVERT(DATETIME, '03-APR-09'),NULL,'1295 WINDY AVENUE', 'KALMAZOO', 'MI', '49002', 6.00); 
INSERT INTO ORDERS 
VALUES (1013,1014,CONVERT(DATETIME, '03-APR-09'),CONVERT(DATETIME, '04-APR-09'),'7618 MOUNTAIN RD.', 'CODY', 'WY', '82414', 2.00); 
INSERT INTO ORDERS 
VALUES (1014,1007,CONVERT(DATETIME, '04-APR-09'),CONVERT(DATETIME, '05-APR-09'), '9153 MAIN STREET', 'AUSTIN', 'TX', '78710', 3.00); 
INSERT INTO ORDERS 
VALUES (1015,1020,CONVERT(DATETIME, '04-APR-09'),NULL,'557 GLITTER ST.', 'TRENTON', 'NJ', '08606', 2.00); 
INSERT INTO ORDERS 
VALUES (1016,1003,CONVERT(DATETIME, '04-APR-09'),NULL,'9901 SEMINOLE WAY', 'TALLAHASSEE', 'FL', '32307', 2.00); 
INSERT INTO ORDERS 
VALUES (1017,1015,CONVERT(DATETIME, '04-APR-09'),CONVERT(DATETIME, '05-APR-09'),'887 HOT ASPHALT ST', 'MIAMI', 'FL', '33112', 3.00); 
INSERT INTO ORDERS 
VALUES (1018,1001,CONVERT(DATETIME, '05-APR-09'),NULL,'95812 HIGHWAY 98', 'EASTPOINT', 'FL', '32328', NULL); 
INSERT INTO ORDERS 
VALUES (1019,1018,CONVERT(DATETIME, '05-APR-09'),NULL, '1008 GRAND AVENUE', 'MACON', 'GA', '31206', 2.00); 
INSERT INTO ORDERS 
VALUES (1020,1008,CONVERT(DATETIME, '05-APR-09'),NULL,'195 JAMISON LANE', 'CHEYENNE', 'WY', '82003', 2.00); 
...
INSERT INTO BOOKS 
VALUES ('1059831198','BODYBUILD IN 10 MINUTES A DAY',CONVERT(DATETIME, '21-JAN-05'),4,18.75,30.95, NULL, 'FITNESS'); 
INSERT INTO BOOKS 
VALUES ('0401140733','REVENGE OF MICKEY',CONVERT(DATETIME, '14-DEC-05'),1,14.20,22.00, NULL, 'FAMILY LIFE'); 
INSERT INTO BOOKS 
VALUES ('4981341710','BUILDING A CAR WITH TOOTHPICKS',CONVERT(DATETIME, '18-MAR-06'),2,37.80,59.95, 3.00, 'CHILDREN'); 
INSERT INTO BOOKS 
VALUES ('8843172113','DATABASE IMPLEMENTATION',CONVERT(DATETIME, '04-JUN-03'),3,31.40,55.95, NULL, 'COMPUTER'); 
INSERT INTO BOOKS 
VALUES ('3437212490','COOKING WITH MUSHROOMS',CONVERT(DATETIME, '28-FEB-04'),4,12.50,19.95, NULL, 'COOKING'); 
INSERT INTO BOOKS 
VALUES ('3957136468','HOLY GRAIL OF ORACLE',CONVERT(DATETIME, '31-DEC-05'),3,47.25,75.95, 3.80, 'COMPUTER'); 
INSERT INTO BOOKS 
VALUES ('1915762492','HANDCRANKED COMPUTERS',CONVERT(DATETIME, '21-JAN-05'),3,21.80,25.00, NULL, 'COMPUTER'); 
INSERT INTO BOOKS 
VALUES ('9959789321','E-BUSINESS THE EASY WAY',CONVERT(DATETIME, '01-MAR-06'),2,37.90,54.50, NULL, 'COMPUTER'); 
INSERT INTO BOOKS 
VALUES ('2491748320','PAINLESS CHILD-REARING',CONVERT(DATETIME, '17-JUL-04'),5,48.00,89.95, 4.50, 'FAMILY LIFE'); 
INSERT INTO BOOKS 
VALUES ('0299282519','THE WOK WAY TO COOK',CONVERT(DATETIME, '11-SEP-04'),4,19.00,28.75, NULL, 'COOKING'); 
INSERT INTO BOOKS 
VALUES ('8117949391','BIG BEAR AND LITTLE DOVE',CONVERT(DATETIME, '08-NOV-05'),5,5.32,8.95, NULL, 'CHILDREN'); 
INSERT INTO BOOKS 
VALUES ('0132149871','HOW TO GET FASTER PIZZA',CONVERT(DATETIME, '11-NOV-06'),4,17.85,29.95, 1.50, 'SELF HELP'); 
INSERT INTO BOOKS 
VALUES ('9247381001','HOW TO MANAGE THE MANAGER',CONVERT(DATETIME, '09-MAY-03'),1,15.40,31.95, NULL,  'BUSINESS'); 
INSERT INTO BOOKS 
VALUES ('2147428890','SHORTEST POEMS',CONVERT(DATETIME, '01-MAY-05'),5,21.85,39.95, NULL, 'LITERATURE'); 
